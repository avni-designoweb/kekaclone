    ...
    <div class="bg-white min-h-screen">
      ...
      <div class="flex min-h-screen items-center justify-center">
        <div class="bg-blue-50 p-8 rounded-lg shadow-lg w-100 flex flex-col items-center justify-center">
          ...
          <div class="flex">
            <Link to="/login">
              <button class="border px-4 py-2 rounded-full text-white bg-blue-500 cursor-pointer hover:bg-white hover:text-blue-300 mr-2">
                Admin
              </button>
            </Link>
            <button class="border px-4 py-2 bg-blue-500 text-white rounded-full cursor-pointer hover:bg-white hover:text-blue-300 ml-2">
              Employee
            </button>
          </div>
          <div>
